...
use http_ng_core::{Error, ErrorKind, Phase, RequestBody, RequireVersion, Timeouts};
use http_ng_h3::H3;
...
///
/// The hedge connects, its handle is dropped, and `http_ng_native::Staged`'s
...
/// [`Selecting::hedging`](http_ng_select::Selecting::hedging) was called.
