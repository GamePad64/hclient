...
//!   [`hclient_core::websocket::WebSocket`] is implemented on. Give it
...
pub struct TungsteniteWebSocket<I, Tm: Timer> {
    ...
    /// `hclient_core::websocket::WebSocket` states, held here rather
...
pub struct Tungstenite<'a, R, T, D, H = hclient_core::hooks::NoHooks>
where
    R: TcpConnect + Timer,
    T: TlsConnect,
{
