...
//! whole point of the sans-io shape. The wiring into `hclient::Client`
...
/// lifetime is assigned: with one, `hclient` would record this body into
...
/// The stored bytes are the wire's, `Content-Encoding` and all — `hclient`
