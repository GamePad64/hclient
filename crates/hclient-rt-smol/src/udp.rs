...
/// describes.
#[cfg(unix)]
impl std::os::fd::AsFd for SmolUdpSocket {
...
#[cfg(windows)]
impl std::os::windows::io::AsSocket for SmolUdpSocket {
...
/// receives.
///
/// **The twin of `hclient_rt_tokio`'s `ecn_is_really_on`, deliberately
...
/// `crates/hclient-rt-pair-check/tests/udp_pair_property.rs` runs the same
...
impl UdpBind for crate::Smol {
    ...
    /// No runtime-context guard, unlike `hclient_rt_tokio::TokioHandle`'s:
...
fn to_quinn(c: hclient_rt::EcnCodepoint) -> quinn_udp::EcnCodepoint {
    match c {
        hclient_rt::EcnCodepoint::Ect0 => quinn_udp::EcnCodepoint::Ect0,
        hclient_rt::EcnCodepoint::Ect1 => quinn_udp::EcnCodepoint::Ect1,
        hclient_rt::EcnCodepoint::Ce => quinn_udp::EcnCodepoint::Ce,
    }
}

fn from_quinn(c: quinn_udp::EcnCodepoint) -> hclient_rt::EcnCodepoint {
    match c {
        quinn_udp::EcnCodepoint::Ect0 => hclient_rt::EcnCodepoint::Ect0,
        quinn_udp::EcnCodepoint::Ect1 => hclient_rt::EcnCodepoint::Ect1,
        quinn_udp::EcnCodepoint::Ce => hclient_rt::EcnCodepoint::Ce,
    }
}
