...
//! `tests/` and running `cargo build --tests -p http-ng-dns-doh`; they are
...
//! error[E0038]: the trait `http_ng_dns::Resolve` is not dyn compatible
//!   --> crates/http-ng-dns/src/lib.rs:132:42
...
//!   --> crates/http-ng-core/src/unversioned/transport.rs:83:10
...
use http_ng_dns::{IpLiteralOnly, Resolve};
