#!/usr/bin/env python3
"""Mutation run for `hclient-quinn`.
...
LIB = "crates/hclient-quinn/src/lib.rs"
ANCHOR = 5
...
MUTATIONS = [
    ...
    (
        ...
        "        hclient_rt::EcnCodepoint::Ect0 => quinn::udp::EcnCodepoint::Ect1,\n"
        "        hclient_rt::EcnCodepoint::Ect1 => quinn::udp::EcnCodepoint::Ect0,",
    ...
    (
        ...
        "        quinn::udp::EcnCodepoint::Ect0 => hclient_rt::EcnCodepoint::Ect1,\n"
        "        quinn::udp::EcnCodepoint::Ect1 => hclient_rt::EcnCodepoint::Ect0,",
...
def run_tests():
    r = subprocess.run(
        ["cargo", "nextest", "run", "-p", "hclient-quinn", "--no-fail-fast"],
        cwd=ROOT,
        capture_output=True,
        text=True,
    )
