...
//! [`Progress`](hclient_core::hooks::Progress) is what it can say
...
//!
//! [`Connected`](hclient_core::hooks::Connected),
//! [`Reused`](hclient_core::hooks::Reused) and
//! [`Closed`](hclient_core::hooks::Closed) are not emitted, and the
...
//! [`ConnectTiming`](hclient_core::hooks::ConnectTiming) plus
...
//! [`Timer`](hclient_core::timer::Timer), and it reads
...
pub(crate) fn mark<H: Hooks>() -> Option<f64> {
    hclient_core::hooks::mark::<H, _>(now)
}
