...
///   which was wrong about the reason. See `http-ng-native`'s `pool`
///   module doc.
///
...
///
/// [`TcpConnect::Stream`](https://docs.rs/http-ng-rt) is the same idea
...
/// fired, and `http-ng-fetch`'s `SendJsFuture` resolves to
