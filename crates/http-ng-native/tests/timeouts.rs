...
use http_ng_core::{ErrorKind, Phase};
use http_ng_dns_system::SystemDns;
use http_ng_native::{BetweenBytesElapsed, FirstByteTimedOut, Native};
...
async fn get_all(timeouts: Timeouts, addr: SocketAddr) -> Result<String, http_ng_core::Error> {
