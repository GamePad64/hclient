...
//! executed:
//!
//! - **`PoolKey`** — `http-ng-h3`'s pool key, and a fact about *sharing a
...
use http_ng_webtransport::{Session, TooManySessions};
use server::Options;
...
/// [`Session::open_session`](http_ng_webtransport::Session::open_session)
