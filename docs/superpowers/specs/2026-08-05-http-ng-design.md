...
`amendment-C1`, `amendment-C2`, `amendment-C3` или `amendment-C4` — в
комментарии `send-bound-exception: amendment-CN`. CI (`no-declared-send`)
проверяет исключения именно по этим токенам, так что цитата и обоснование
находятся одним и тем же поиском.
