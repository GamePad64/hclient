...
EXPECTED = {
    ...
    "absent; `http-ng-ws-tungstenite` never offers the extension in its handshake, so "
...
def main():
    ...
    if undeclared:
        die(
            ...
            "either a defect in crates/http-ng-ws-tungstenite/src/lib.rs or a decision that "
